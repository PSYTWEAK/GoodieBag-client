...
import { combineUSDVolumeThenRemoveDuplicates, removeBlueChips, removeStables, removeSignOfDerivInTokenName, sortByVolume } from ".././filters";
...
const sushiQuery = `
  ...
  `;
export default async function useHighestVolume(config: any) {
